                        ...
                        if(len(job)>=1):
                            ...
                            for job in job:
                                ...
                                for i in range(int(delayfl),-1,-1):
                                    print(f'{Red}[{Black}N-Code]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}|{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Yellow}N-Code]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}/{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Purple}N-Code]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}-{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Cyan}N-Code]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}+{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Green}N-Code]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}\{Red}] ',end='\r')
                                    sleep(0.2)
                                if(kkk==sofl):
                                    break
