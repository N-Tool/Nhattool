...
def addcookie(settingmenu):
    while True:
        cookie = input(nhatdz+luc+f'Nhập Cookie Tiktok {luc}: {vang}')
        try:
...
\033[1;36m║▇▇▇▇◣▇◢▇▇▇▇║
\033[1;34m╚═══════════╝
\033[1;97mTool By: \033[1;32mNhattCode            \033[1;97mPhiên Bản: \033[1;32m4.0     
\033[97m════════════════════════════════════════════════  
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m Youtube\033[1;31m  : \033[1;97m☞ \033[1;36mNHẬT DVMXH\033[1;31m♔ \033[1;97m☜
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m Telegram\033[1;31m : \033[1;97m☞\033[1;32mhttps://t.me/nhomsharetool🔫\033[1;97m☜
\033[97m════════════════════════════════════════════════
"""
        ...
        print("\033[1;31mYouTube : \033[1;33mNHẬT \033[1;33mDVMXH\033[1;32m")
...
def generate_key_and_url(ip_address):
    ...
    key = f'Nhatcode{key1}{ip_numbers}'
...
def main():
    ...
    if ip_address:
        ...
        if existing_key:
            ...
            token_8link = '6671b17cc2957c24526bc20d'
...
def dlow_delay(x:int):
    while x > 0:
        ...
        min = int(x / 60) % 60
        hou = int(x / 3600)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33mXXXXX\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33mX.X.X\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m.X.X.\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33mX...X\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33mX....\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m.X...\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m..X..\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m...X.\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m....X\033[1;37m]','          ', end="\r");sleep(1/14)
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33m...X.\033[1;37m]','          ', end="\r");sleep(1/14)
        ...
        print(f' \033[1;37m[\033[1;96mNhatCode\033[1;37m] \033[1;37m[\033[1;96mDelay\033[1;37m] \033[1;37m[\033[1;96m{hou:02}:{min:02}:{sec:02}\033[1;37m] \033[1;37m[\033[1;33mXXXXX\033[1;37m]','          ', end="\r");sleep(1/14)
        x = x - 1
    print(f' \033[1;37m              N - Tool                ',end="\r")
logo()

if os.path.exists(f'N-Tool-authorizationgolike.json') == False:
    while(True):
        token = input(nhatdz+luc+'Nhập Authorization Golike:'+vang+' ')
        ...
        try:
            ...
            with open('N-Tool-authorizationgolike.json','w') as f: json.dump([token+'|'+users+' - '+ name],f);break
        except: print(do+'Đăng Nhập Thất Bại')
else:
    token_json = json.loads(open('N-Tool-authorizationgolike.json','r').read())
    stt_token = 0
    for tokens in token_json:
        if len(tokens) > 5: stt_token += 1; print('{}{}Account {}[{}{}{}] {}Để Chạy Tài Khoản: {}{}'.format(nhatdz,luc,do,vang,stt_token,do,luc,vang,tokens.split('|')[1]))
    print(thanhngang)
    print('{}{}Nhập {}[{}{}{}] {}Chọn Acc Golike Để Chạy Tool'.format(nhatdz,luc,do,vang,'1',do,luc))
    print('{}{}Nhập {}[{}{}{}] {}Nhập Authorization Golike Mới'.format(nhatdz,luc,do,vang,'2',do,luc))
    print(thanhngang)
    while True:
        type_  = input(F'{nhatdz}{luc}Nhập: {vang}')
        print(thanhngang)
        if type_ == '1':
            while True:
                try:
                    tokenauthorizationgolikegolike = int(input(f'{nhatdz}{luc}Nhập Số Acc: {vang}'))
                    print(thanhngang)
...
if os.path.exists(f'N-Tool-cookietiktok-golike.json') == False:
    cookie = addcookie(settingmenu)
    with open('N-Tool-cookietiktok-golike.json','w') as f: json.dump(listCookie, f)
else:
    print('{}{}Nhập {}[{}{}{}] {}Sử Dụng Cookie Tik Tok Đã Lưu'.format(nhatdz,luc,do,vang,'1',do,luc))
    print('{}{}Nhập {}[{}{}{}] {}Nhập Cookie Tik Tok Mới '.format(nhatdz,luc,do,vang,'2',do,luc))
    print(thanhngang)
    type_ = input('{}{}Nhập: {}'.format(nhatdz,luc,vang)); print(thanhngang)
    while True:
...
print(nhatdz+luc+f'Họ Và Tên: {vang}{name}')
print(nhatdz+luc+f'Tên Tài Khoản: {vang}{users}')
print(nhatdz+luc+f'Số Dư: {vang}{str(coin)}')
print(thanhngang)
while(True):
    try:delay = int(input(nhatdz+luc+'Delay Tool:'+vang+' ')); break
    except:print(do+' Vui Lòng Nhập Số')
while(True):
    try:DelayBlock = int(input(nhatdz+luc+'Sau Khi Phát Hiện Block Thì Nghỉ Bao Nhiêu Giây:'+vang+' ')); break
    except:print(do+' Vui Lòng Nhập Số')
print(thanhngang)
stt = 0
jobfail = 0
